...
if __name__ == '__main__':
    ...
    recom_number = 20
    args = get_args()
    bsize=128 #args.batch_size
    embed_dim= 50 #args.embed_dim
    encod_dim=128 # args.nhid
    embed_dim_policy = 50 #args.embed_dim_policy
    encod_dim_policy=128 # args.nhid_policy
    ...
    if load:
        #Absolute route
        environment = "../simulation_task1/model_output/environment.pickle"
        policy_new = "model_output/agent.pickle"
    ...
    max_length = 5
    #Absolute route
    file_action = '../simulation_task1/gen_click.txt'
    file_reward = '../simulation_task1/gen_reward.txt'
    file_recom = '../simulation_task1/gen_action.txt'
    #for i in range(5):
